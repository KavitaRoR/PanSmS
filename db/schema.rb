...
ActiveRecord::Schema.define(:version => 20140314081350) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_id"=>nil, "student_id"=>nil, "observable_type"=>nil, "exam_id"=>nil, "batch_id"=>nil}
  ...
  create_table "exam_scores", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "ca1",              :precision => 7, :scale => 2
    t.decimal  "ca2",              :precision => 7, :scale => 2
    t.decimal  "ca3",              :precision => 7, :scale => 2
  end
