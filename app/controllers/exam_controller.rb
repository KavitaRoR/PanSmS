...
class ExamController < ApplicationController
  ...
  helper_method :remarks_constant, :comments
  def index
  end
  ...
  #Added on 14-03-2014
  def comments
    comm = {0..39 => "Very poor result, please wake up",
            40..49 => "Fair result, please put more efford",
            50..59 => "Good result, but work harder next time",
            60..69 => "Very good result, but you can do more",
            70..100 => "Excellent result, keep it up"}
  end
